...
import "./App.css";
import './musicList/musicList.js';
import './musicItem/musicItem.js';
class App extends Component {
	...
	render() {
      ...
      //<ReactiveBase app='bands' type='_doc' url='https://amp.a-magdy.me'>
			...
			} > < div className = "navbar" > < div className = "logo-container" > < img className = "app-logo"
			src = "Images/logo1.gif"
			alt = "African Music Archive" / > < /div> < div className = "search-container" > < DataSearch autosuggest = {
				true
			}
			componentId = "search"
			dataField = {
